...
image = cv2.imread('Downloads/object_10.png')
detect_color_from_array(image)

image = cv2.imread('Downloads/object_11.png')
detect_color_from_array(image)


image = cv2.imread('Downloads/object_12.png')
detect_color_from_array(image)

image = cv2.imread('Downloads/object_13.png')
detect_color_from_array(image)

image = cv2.imread('Downloads/object_15.png')
detect_color_from_array(image)


image = cv2.imread('Downloads/object_19.png')
detect_color_from_array(image)